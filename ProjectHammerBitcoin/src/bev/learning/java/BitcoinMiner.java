...
public class BitcoinMiner {
    ...
    public void play() {
        ...
        while (year <= 10 && stillInOffice) { //after year 11 and still in not false
    ...
    private int buyComputers(int numberOfComputers) {
        ...
        int computersToBuy = getNumber(question);
    ...
    private int payEmployees(int cash) {
        ...
        System.out.printf("%s, %s bitcoins remain.%n", OGH, cash - cashPaidToEmployees);
        return cashPaidToEmployees;
    }
    ...
    private int getNumber(String message) {
        while (true) {
            ...
            } catch (Exception ignored) { //if error, prints message
    ...
    public static boolean getYesOrNo(String question) {
        ...
        while (true) {  // infinite loop.  return will exit the method, thus terminating the loop
            ...
            answer = answer.toLowerCase(); //converts response to lowercase
